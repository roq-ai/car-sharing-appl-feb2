  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover a new way to commute with Car Sharing Application - Efficient, sustainable, and convenient. Your journey towards smarter mobility starts here."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1605618312848-1c2f4e6fd755?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjBzaGFyaW5nfGVufDB8fHx8MTY5Njc4NDA5Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover a new way to commute with Car Sharing Application - Efficient, sustainable, and convenient. Your journey towards smarter mobility starts here.`}
            </Text>
            <Box
