...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'car_issue_reported.create': {
    roles: ['business-owner', 'team-member', 'customer-service-representative'],
    key: 'car_issue',
    tenantPath: [],
    userPath: [],
  },
  'car_issue_resolved.update': {
    roles: ['business-owner', 'team-member', 'car-owner'],
    key: 'car_issue',
    tenantPath: [],
    userPath: [],
  },
  'car_status_updated.update': {
    roles: ['business-owner', 'customer-service-representative', 'car-owner'],
    key: 'car_status',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'customer-service-representative', 'car-owner'];
